...
amphibian_status_impervious<- ggplot(florida_herp_impervious_amphibian)+
  ...
  ylab("Status")+
  ggtitle("Percent Impervious Surface Occupied by Native and Invasive Amphibians")+
...
amphibian_impervious_plot<- ggplot(florida_herp_impervious_amphibian)+
  ...
  xlab("Mean Percent Impervious Surface")+
  ylab("Species")+
  ggtitle("Percent Impervious Surface Occupied by Amphibian Species")+
  theme(axis.text.y = element_text(size = 16),
        axis.title.y = element_text(size = 18),
        axis.text.x = element_text(size = 16),
        axis.title.x = element_text(size = 18), 
...
squamata_status_impervious<- ggplot(florida_herp_impervious_squamata)+
  ...
  xlab("Mean Percent Impervious Surface")+
  ylab("Status")+
  ggtitle("Percent Impervious Surface Occupied by Native and Invasive Squamates")+
  theme(axis.text.y = element_text(size = 16),
        axis.title.y = element_text(size = 18),
        axis.text.x = element_text(size = 16),
        axis.title.x = element_text(size = 18), 
...
squamata_impervious_plot<- ggplot(florida_herp_impervious_squamata)+
  ...
  xlab("Mean Percent Impervious Surface")+
  ylab("Species")+
  ggtitle("Percent Impervious Surface Occupied by Squamate Species")+
  theme(axis.text.y = element_text(size = 16),
        axis.title.y = element_text(size = 18),
        axis.text.x = element_text(size = 16),
        axis.title.x = element_text(size = 18), 
...
amphibian_status_precipitation<- ggplot(florida_herp_precipitation_amphibian)+
  ...
  ylab("Status")+
  ggtitle("Mean Annual Precipitation Occupied by Native and Invasive Amphibians (mm)")+
  theme(axis.text.y = element_text(size = 16),
        axis.title.y = element_text(size = 18),
        axis.text.x = element_text(size = 16),
        axis.title.x = element_text(size = 18), 
...
amphibian_precipitation_plot<- ggplot(florida_herp_precipitation_amphibian)+
  ...
  xlab("Mean Annual Precipitation (mm)")+
  ylab("Species")+
  ggtitle("Mean Annual Precipitation Occupied by Amphibian Species (mm)")+
  theme(axis.text.y = element_text(size = 16),
        axis.title.y = element_text(size = 18),
        axis.text.x = element_text(size = 16),
        axis.title.x = element_text(size = 18), 
...
squamata_status_precipitation<- ggplot(florida_herp_precipitation_squamata)+
  ...
  xlab("Mean Annual Precipitation (mm)")+
  ylab("Status")+
  ggtitle("Mean Annual Precipitation Occupied by Native and Invasive Squamates (mm)")+
  theme(axis.text.y = element_text(size = 16),
        axis.title.y = element_text(size = 18),
        axis.text.x = element_text(size = 16),
        axis.title.x = element_text(size = 18), 
...
squamata_precipitation_plot<- ggplot(florida_herp_precipitation_squamata)+
  ...
  xlab("Mean Annual Precipitation (mm)")+
  ylab("Species")+
  ggtitle("Mean Annual Precipitation Occupied by Squamate Species (mm)")+
  theme(axis.text.y = element_text(size = 16),
        axis.title.y = element_text(size = 18),
        axis.text.x = element_text(size = 16),
        axis.title.x = element_text(size = 18), 
...
amphibian_status_maxtemp<- ggplot(florida_herp_maxtemp_amphibian)+
  ...
  ylab("Status")+
  ggtitle("Mean Annual Max Temperature Occupied by Native and Invasive Amphibians (C)")+
  theme(axis.text.y = element_text(size = 16),
        axis.title.y = element_text(size = 18),
        axis.text.x = element_text(size = 16),
        axis.title.x = element_text(size = 18), 
...
amphibian_maxtemp_plot<- ggplot(florida_herp_maxtemp_amphibian)+
  ...
  xlab("Mean Annual Max Temperature (C)")+
  ylab("Species")+
  ggtitle("Mean Annual Max Temperature Occupied by Amphibian Species (C)")+
  theme(axis.text.y = element_text(size = 16),
        axis.title.y = element_text(size = 18),
        axis.text.x = element_text(size = 16),
        axis.title.x = element_text(size = 18), 
...
squamata_status_maxtemp<- ggplot(florida_herp_maxtemp_squamata)+
  ...
  xlab("Mean Annual Max Temperature (C)")+
  ylab("Status")+
  ggtitle("Mean Annual Max Temperature Occupied by Native and Invasive Squamates (C)")+
  theme(axis.text.y = element_text(size = 16),
        axis.title.y = element_text(size = 18),
        axis.text.x = element_text(size = 16),
        axis.title.x = element_text(size = 18), 
...
squamata_maxtemp_plot<- ggplot(florida_herp_maxtemp_squamata)+
  ...
  xlab("Mean Annual Max Temperature (C)")+
  ylab("Species")+
  ggtitle("Mean Annual Max Temperature Occupied by Squamate Species (C)")+
  theme(axis.text.y = element_text(size = 16),
        axis.title.y = element_text(size = 18),
        axis.text.x = element_text(size = 16),
        axis.title.x = element_text(size = 18), 
...
amphibian_status_mintemp<- ggplot(florida_herp_mintemp_amphibian)+
  ...
  ylab("Status")+
  ggtitle("Mean Annual Min Temperature Occupied by Native and Invasive Amphibians (C)")+
  theme(axis.text.y = element_text(size = 16),
        axis.title.y = element_text(size = 18),
        axis.text.x = element_text(size = 16),
        axis.title.x = element_text(size = 18), 
...
amphibian_mintemp_plot<- ggplot(florida_herp_mintemp_amphibian)+
  ...
  xlab("Mean Annual Min Temperature (C)")+
  ylab("Species")+
  ggtitle("Mean Annual Min Temperature Occupied by Amphibian Species (C)")+
  theme(axis.text.y = element_text(size = 16),
        axis.title.y = element_text(size = 18),
        axis.text.x = element_text(size = 16),
        axis.title.x = element_text(size = 18), 
...
squamata_status_mintemp<- ggplot(florida_herp_mintemp_squamata)+
  ...
  xlab("Mean Annual Min Temperature (C)")+
  ylab("Status")+
  ggtitle("Mean Annual Min Temperature Occupied by Native and Invasive Squamates (C)")+
  theme(axis.text.y = element_text(size = 16),
        axis.title.y = element_text(size = 18),
        axis.text.x = element_text(size = 16),
        axis.title.x = element_text(size = 18), 
...
squamata_mintemp_plot<- ggplot(florida_herp_mintemp_squamata)+
  ...
  xlab("Mean Annual Min  Temperature (C)")+
  ylab("Species")+
  ggtitle("Mean Annual Min  Temperature Occupied by Squamate Species (C)")+
  theme(axis.text.y = element_text(size = 16),
        axis.title.y = element_text(size = 18),
        axis.text.x = element_text(size = 16),
        axis.title.x = element_text(size = 18), 
